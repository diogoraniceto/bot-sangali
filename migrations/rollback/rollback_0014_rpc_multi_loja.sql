-- Rollback da 0014: volta o filtro de loja para igualdade exata (corpo da 0013).
-- Sintoma que justifica: busca voltando itens de loja que nao entrega, ou queda de
-- conformidade na eval atribuida ao pool maior.
-- ATENCAO: rode o PROMPT de volta para id_loja="244033" ANTES desta migration.
-- Invertido, o prompt manda "244033,94134" para a funcao de igualdade e TODA busca
-- volta vazia. (E o inverso da ordem de deploy.)
-- CREATE OR REPLACE, mesma assinatura: nao cria sobrecarga.
